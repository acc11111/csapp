...
0000000000400fce <func4>:
  ...
  400fdb:	01 c8                	add    %ecx,%eax # eax += ecx，也就是eax = eax + num1 -eax = num1
  400fdd:	d1 f8                	sar    %eax # eax >>= 1，也就是eax = num1 / 2
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx # ecx = rax + rsi = num1 / 2
  400fe2:	39 f9                	cmp    %edi,%ecx 
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24> # if(num1 <= num1 /2) goto 400ff2
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx # edx = rcx - 1 = num1 / 2 - 1
  400fe9:	e8 e0 ff ff ff       	call   400fce <func4>
  400fee:	01 c0                	add    %eax,%eax
  400ff0:	eb 15                	jmp    401007 <func4+0x39>
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax # eax = 0
  400ff7:	39 f9                	cmp    %edi,%ecx # 比较edi和ecx,也就是num1 和 num1 / 2比较
  400ff9:	7d 0c                	jge    401007 <func4+0x39> # if(num1 >= num1 / 2 ) goto 401007
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi # esi = rcx + 1 = num1 / 2 + 1
  400ffe:	e8 cb ff ff ff       	call   400fce <func4> # 调用func4,此时三个参数分别为num1 / 2 + 1, num1, 14
...
00000000004013a2 <initialize_bomb>: # 初始化炸弹的地方，此时只需要找到是如何初始化炸弹的
  4013a2:	48 83 ec 08          	sub    $0x8,%rsp # 分配8个字节的空间
  4013a6:	be a0 12 40 00       	mov    $0x4012a0,%esi # 将0x4012a0赋值给%esi，也即是sig_handler函数的地址，这是一个信号处理函数
  4013ab:	bf 02 00 00 00       	mov    $0x2,%edi # 将2赋值给%edi,这是第一个参数
  4013b0:	e8 db f7 ff ff       	call   400b90 <signal@plt> # 调用signal函数，这个函数是用来注册信号处理函数的
  4013b5:	48 83 c4 08          	add    $0x8,%rsp # 释放8个字节的空间
  4013b9:	c3                   	ret    
